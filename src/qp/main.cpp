            ...
            if(pid >0)
            {
                ...
                }else
                {
                    ...
                    if(Config::get_mutable_instance().ha_on())
                    {
                        ...
                        nrt=HA_REG("qp",Config::get_mutable_instance().local_ip(),Config::get_mutable_instance().server_port());
                        if(nrt != 0)
                        {
...
int init(int argc, char * argv [])
{
    ...
    do{
        ...
        /*step 4: 创建Net实例*/
        QpServer::get_mutable_instance().bindaddr(
        ...
        CommFactoryInterface::instance().add_comm(&(QpServer::get_mutable_instance()));
        ...
        RedisPool::get_mutable_instance().set_handle(RA_USER, QpServer::s_on_get_user_tag);
        RedisPool::get_mutable_instance().set_handle(RA_USER_GAME, QpServer::s_on_get_user_game_tag);
        RedisPool::get_mutable_instance().set_handle(RA_DEVICE, QpServer::s_on_get_device_price);
