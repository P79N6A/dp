...
#ifndef  _PROCESS_SN_H_ 
#define  _PROCESS_SN_H_
...
namespace control
{
class ProcessSn:public dc::common::comm_event::CommBase, public boost::serialization::singleton<ProcessSn>
{
...
public:
     ...
     **/
    int proc_result(sn::SNResponse & rsp);
     ...
     **/
    int get_sn_addr(struct sockaddr_in * addr);

};
}
}

#endif   // ----- #ifndef _PROCESS_SN_H_  ----- 
