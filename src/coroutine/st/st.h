...
typedef int(*co_socket_t)(int domain, int type, int protocol);
typedef int(*co_close_t)(int fd);
typedef int(*co_connect_t)(int fd, const struct sockaddr *, socklen_t);
typedef int(*co_accept_t)(int fd, struct sockaddr *addr, socklen_t *addrlen);
typedef ssize_t(*co_read_t)(int fd, void *buf, size_t len);
typedef ssize_t(*co_recv_t)(int fd, void *buf, size_t len, int flags);
typedef ssize_t(*co_recvfrom_t)(int fd, void *buf, size_t len, int flags,
    struct sockaddr *src_addr, socklen_t *addrlen);
typedef ssize_t (*co_write_t)(int fd, const void *buf, size_t nbyte);
typedef ssize_t (*co_send_t)(int fd, const void *buf, size_t len, int flags);
typedef ssize_t (*co_sendto_t)(int fd, const void *buf, size_t len,
    int flags, const struct sockaddr *addr, socklen_t addrlen);
typedef int (*co_getsockopt_t)(int sockfd, int level, int optname,
    void *optval, socklen_t *optlen);
typedef int (*co_setsockopt_t)(int sockfd, int level, int optname,
    const void *optval, socklen_t optlen);

extern co_close_t glibc_close;
extern co_connect_t glibc_connect;
extern co_socket_t glibc_socket;
extern co_accept_t glibc_accept;
extern co_read_t glibc_read;
extern co_recv_t glibc_recv;
extern co_write_t glibc_write;
extern co_recvfrom_t glibc_recvfrom;
extern co_send_t glibc_send;
extern co_sendto_t glibc_sendto;
extern co_getsockopt_t glibc_getsockopt;
extern co_setsockopt_t glibc_setsockopt;

#define STATE_THREAD_FD(osfd) state_thread_fds[(osfd)]
extern st_netfd_t state_thread_fds[];
